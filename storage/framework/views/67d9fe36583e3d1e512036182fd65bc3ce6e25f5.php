...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <?php if(Request::is('dashboard3/books/id')): ?>
        <h1 class="h3 mb-0 text-gray-800"><?php echo e($title1); ?></h1>
        <?php else: ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mb-2 mb-4">
            <a href="<?php echo e(Request::is('dashboard3*') ? '/dashboard3/books/id' : '/books/id'); ?>" class="text-decoration-none">
                <div class="card mx-auto" style="width: 15rem;">
...
<?php echo $__env->make('app.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadrafli/Documents/app-laravel/laravel-sipmah/resources/views/contents/categories/detail.blade.php ENDPATH**/ ?>