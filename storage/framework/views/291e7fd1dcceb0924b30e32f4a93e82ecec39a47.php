        ...
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                <div class="col-lg-12 mt-3">
                    <?php if(Request::is('publishers*', 'dashboard2/publishers*')): ?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="">
                                        <a href="<?php echo e(Request::is('dashboard3*') ? '/dashboard3/publishers/id' : '/publishers/id/books'); ?>"
                                            class="btn btn-sm btn-outline-success" data-toggle="tooltip"
                                            data-placement="top" title="Detail">
                                            <i class="fas fa-eye"></i>
                                        </a>

                                        <?php if(Request::is('dashboard2*', 'publishers*')): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="">
                                        <a href="<?php echo e(Request::is('dashboard3*') ? '/dashboard3/publishers/id' : '/publishers/id'); ?>"
                                            class="btn btn-sm btn-outline-success" data-toggle="tooltip"
                                            data-placement="top" title="Detail">
                                            <i class="fas fa-eye"></i>
                                        </a>
...
<?php echo $__env->make('app.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadrafli/Documents/app-laravel/laravel-sipmah/resources/views/contents/publishers/index.blade.php ENDPATH**/ ?>