                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="">
                                            <a href="<?php echo e(Request::is('dashboard3*') ? '/dashboard3/categories/id' : '/racks/id/categories/id/books'); ?>" class="btn btn-sm btn-outline-success"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="">
                                            <a href="<?php echo e(Request::is('dashboard3*') ? '/dashboard3/categories/id' : '/categories/id'); ?>" class="btn btn-sm btn-outline-success"
                                            data-toggle="tooltip" data-placement="top" title="Detail"><i
                                                class="fa-solid fa-eye"></i></a>
                                                <?php if(Request::is('dashboard3*')): ?>
...
<?php echo $__env->make('app.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muhamadrafli/Documents/app-laravel/laravel-sipmah/resources/views/contents/racks/detail.blade.php ENDPATH**/ ?>